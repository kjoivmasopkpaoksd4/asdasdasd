...
[![Java CI](https://github.com/kjoivmasopkpaoksd4/asdasdasd/actions/workflows/1.pipeline.yml/badge.svg)](https://github.com/kjoivmasopkpaoksd4/asdasdasd/actions/workflows/1.pipeline.yml)
...
[![Javadoc](https://img.shields.io/badge/JavaDoc-Online-green)](https://kjoivmasopkpaoksd4.github.io/asdasdasd/javadoc/)
...
2. Create & provide a PAT (Personal Access Token) for the CI/CD pipeline
   ...
   1. If the new repo owner is an organisation, **enrol** the organisation for '**Fine-grained personal access tokens**'. In the organisation ['Settings > Third-party Access > Personal access tokens'](https://github.com/organizations/kjoivmasopkpaoksd4/settings/personal-access-tokens).
...
4. Final one-off tasks
   ...
   * Update _Maven Publication_ details [here](fancy-library-name/build.gradle.kts#L6-L13)
...
* `fancy-library-name/`: The library source code (Gradle sub-project).
...
## CI/CD Pipeline
The heart of this template is the ['Main GitHub Actions CI/CD Pipeline'](https://github.com/kjoivmasopkpaoksd4/asdasdasd/actions/workflows/1.pipeline.yml).
...
Please define the secrets via your repository settings. ([Settings > Security > Secrets and variables > Actions](https://github.com/kjoivmasopkpaoksd4/asdasdasd/settings/secrets/actions))
...
To host the generated Javadoc, configure GitHub Pages for your repository to deploy from branch `gh-pages`. You can also find all deployments under ['pages-build-deployment'](https://github.com/kjoivmasopkpaoksd4/asdasdasd/actions/workflows/pages/pages-build-deployment).
